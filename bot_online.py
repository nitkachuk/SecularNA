    ...
    while True:
        try:
            ...
            response = g4f.ChatCompletion.create(
                ...
                messages=[ 
                    {"role": "system", "content": "ответь по-русски, если в твоем ответе есть код, то оберни его в тройные нижние подчеркивания по примеру __код__ с экранированием для markdown_v2"},
