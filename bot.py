...
async def main():
    ...
    message_to_send = """Членство в Анонимных — это не просто формальность\, а глубокий внутренний процесс\, который начинается с осознания своей зависимости и желания изменить свою жизнь\. Каждый из нас имеет право на выбор\, и именно это право делает путь к восстановлению уникальным и личным\. 🌱✨ Важно помнить\, что поддержка и понимание со стороны окружающих могут сыграть значительную роль\, но истинное желание изменить свою жизнь должно исходить от самого человека\. 
Программа основана на принципах взаимопомощи и принятия\, а не на давлении\. Мы можем делиться своим опытом и поддерживать тех\, кто ищет помощи\, но не можем заставить их следовать нашим путем\. 💬❤️ Каждый шаг к выздоровлению — это шаг к свободе\, и только тот\, кто готов\, сможет его сделать\. Важно быть благодарным за возможность быть частью этой сообщества и за поддержку\, которую мы можем предоставить друг другу\. 🙏🌟"""
